...
namespace WeaddingPlanner.Controllers
{
    public class PartnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryId,Name,Address,Phone,Email,CommissionPct")] Partner partner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategoryId,Name,Address,Phone,Email,CommissionPct")] Partner partner)
        {
            if (id != partner.Id)
            {
                return NotFound();
